...
export const INTERACTION_LAYOUT = {
  research: { x: 102, y: 7, width: 58, height: 27 },
  archive: { x: 315, y: 7, width: 54, height: 27 },
  coreConsole: { x: 382, y: 7, width: 76, height: 27 },
  crewBoard: { x: 10, y: 7, width: 82, height: 27 },
